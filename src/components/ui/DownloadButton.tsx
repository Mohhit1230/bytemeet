        ...
        className={`rounded-lg p-2 transition-all ${
          downloadComplete
            ...
            : disabled
              ...
              : 'bg-bg-100/90 hover:bg-bg-200 text-gray-400 hover:text-white'
      ...
      <button
        ...
        className={`flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm transition-all ${
          downloadComplete
            ? 'bg-green-500/20 text-green-400'
            : disabled
              ? 'bg-bg-100/50 cursor-not-allowed text-gray-600'
              : 'bg-bg-100 hover:bg-bg-200 text-gray-300 hover:text-white'
        } ${className}`}
      >
        {downloadComplete ? (
          <>
