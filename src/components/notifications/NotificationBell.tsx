    ...
    return (
        <div className={`relative ${className}`}>
            <button
                ref={bellRef}
                onClick={handleClick}
                className={`relative rounded-lg p-2 transition-all ${isOpen
            ...
            >
                ...
                {unreadCount > 0 && (
                    <span
                        ref={badgeRef}
                        className="absolute -right-1 -top-1 flex h-5 min-w-[20px] items-center justify-center rounded-full bg-accent px-1 text-xs font-bold text-white shadow-lg shadow-accent/30"
                    >
                ...
                {unreadCount > 0 && (
                    <span className="absolute -right-1 -top-1 h-5 w-5 animate-ping rounded-full bg-accent opacity-40" />
                )}
            </button>
