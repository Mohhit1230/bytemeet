...
export default function LandingPage() {
  ...
  return (
    <div className="selection:bg-accent min-h-screen bg-black text-white selection:text-white">
      ...
      >
        {/* Background effects */}
        <div className="bg-accent/20 absolute top-[-20%] left-[-10%] h-[500px] w-[500px] rounded-full blur-[120px]" />
        <div className="bg-accent-secondary/15 absolute right-[-10%] bottom-[-20%] h-[600px] w-[600px] rounded-full blur-[140px]" />

        <h1 ref={titleRef} className="text-center text-6xl tracking-tight md:text-8xl lg:text-9xl">
        ...
        <div ref={buttonsRef} className="mt-10 flex flex-col gap-4 sm:flex-row">
          <Link
            href="/register"
            className="bg-accent hover:bg-accent-dark hover:shadow-accent/25 rounded-full px-8 py-4 text-lg font-bold text-white transition-transform hover:scale-105 hover:shadow-lg"
          >
            Get Started Free
          </Link>
          <Link
