...
export default function RegisterPage() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black/70 py-6">
      ...
      <div className="bg-accent/15 absolute top-[-20%] right-[-10%] h-[400px] w-[400px] rounded-full blur-[120px]" />
      <div className="bg-accent-secondary/12 absolute bottom-[-20%] left-[-20%] h-[500px] w-[500px] rounded-full blur-[140px]" />
    </div>
  );
}
