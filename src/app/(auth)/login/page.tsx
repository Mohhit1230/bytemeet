...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-end justify-center overflow-hidden bg-black/80 lg:items-center">
      ...
      />
      <nav className="fixed top-0 right-0 left-0 z-50 px-6 py-6 md:px-12">
        <svg
      ...
      <div className="bg-accent-secondary-dark/25 absolute right-[-15%] bottom-[-30%] h-125 w-125 rounded-full blur-[120px]" />
    </div>
  );
}
