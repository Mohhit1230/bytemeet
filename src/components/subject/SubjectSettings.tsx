...
export function SubjectSettings({ isOpen, onClose, subject, onUpdate }: SubjectSettingsProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div ref={modalRef} className="relative w-full max-w-md bg-[#1e1f20] border border-[#30302e] rounded-2xl shadow-2xl">
                ...
                <div className="px-6 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-[#262624] border border-[#30302e] rounded-lg text-white"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full px-4 py-3 bg-[#262624] border border-[#30302e] rounded-lg text-white resize-none"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            <code className="flex-1 px-4 py-3 bg-[#262624] border border-[#30302e] rounded-lg text-[#e94d37] font-mono text-lg font-bold">
                                {subject?.invite_code}
                            </code>
                            <button
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        className="flex-1 px-4 py-2 bg-[#30302e] hover:bg-[#3a3a38] text-white rounded-lg transition-colors"
                                    >
                                        Cancel
                                    </button>
                                </div>
                ...
                <div className="px-6 py-4 border-t border-[#30302e] flex gap-3">
                    <button
                        onClick={handleClose}
                        disabled={loading}
                        className="flex-1 px-4 py-3 bg-[#30302e] text-white rounded-lg hover:bg-[#3a3a38] transition-colors"
                    >
                        Cancel
                    </button>
                    <button
                        ...
                        disabled={loading}
                        className="flex-1 px-4 py-3 bg-gradient-to-r from-[#f06b58] to-[#e94d37] text-white rounded-lg hover:from-[#e94d37] hover:to-[#d44330] transition-all"
                    >
