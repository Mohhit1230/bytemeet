...
export function MobileNav({ isOpen, onClose, navItems }: MobileNavProps) {
    ...
    return (
        <>
            ...
            <div
                ref={overlayRef}
                className="fixed inset-0 z-50 bg-black/60 opacity-0 pointer-events-none backdrop-blur-sm"
                onClick={onClose}
            />
            ...
            <div
                ref={drawerRef}
                className="fixed left-0 top-0 z-50 h-full w-72 -translate-x-full bg-bg-500 shadow-2xl"
                style={{
            ...
            >
                <div className="flex h-full flex-col">
                    {/* Header */}
                    <div className="flex items-center justify-between border-b border-bg-200 p-4">
                        ...
                        <button
                            onClick={onClose}
                            className="rounded-lg p-2 text-gray-400 transition-colors hover:bg-bg-100 hover:text-white"
                        >
                            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path
                                    strokeLinecap="round"
                                ...
                                <li key={item.id}>
                                    <button
                                        ...
                                        className={`group flex w-full items-center gap-3 rounded-lg px-4 py-3 text-left transition-colors ${isActive(item)
                                                ...
                                                : 'text-gray-300 hover:bg-bg-100 hover:text-white'
                                            }`}
                                    >
                                        {/* Icon */}
                                        <span
                    ...
                    {/* Footer */}
                    <div className="border-t border-bg-200 p-2">
                        <button
...
export function HamburgerButton({ isOpen, onClick, className = '' }: HamburgerButtonProps) {
    ...
    return (
        <button
            onClick={onClick}
            className={`relative flex h-10 w-10 flex-col items-center justify-center gap-1.5 rounded-lg transition-colors hover:bg-bg-100 ${className}`}
