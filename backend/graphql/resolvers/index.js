...
const resolvers = {
  ...
  Subject: {
    ...
    artifacts: async (subject, { filter }, context) => {
      return artifactResolvers.queries.artifacts(_, { subjectId: subject.id, filter }, context);
    },
    artifactStats: async (subject, _, context) => {
      return artifactResolvers.queries.artifactStats(_, { subjectId: subject.id }, context);
    },
  },
